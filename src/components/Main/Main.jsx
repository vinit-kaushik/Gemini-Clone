        ...
        <div className="main-bottom">
          <div className="search-box">
            ...
            <div>
              ...
              {/* {loading ? <p>Loading...</p> : <img onClick={()=>onSent()} src={assets.send_icon} alt="" />} */}
            </div>
          </div>
          <p className="bottom-info">
            Gemini may display info, including about people, so doube click its response. Your privacy and Gemini Apps.
          </p>
        </div>
      </div>
    </div>
